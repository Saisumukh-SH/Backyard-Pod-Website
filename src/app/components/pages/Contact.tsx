    ...
    <div className="grid lg:grid-cols-[60%_40%] gap-20 items-center">
      ...
      <div>
        ...
        <p className="text-[#5F5A55] text-lg max-w-xl leading-relaxed">
          Whether you're planning a backyard studio, granny flat,
          home office or simply exploring ideas, our team is here
          to help guide your next step.
        </p>
      ...
      <div>
        ...
        <div className="bg-white rounded-[32px] p-10 border border-[rgba(46,42,38,0.08)]">
          ...
          <p className="text-[#5F5A55] leading-relaxed">
            ...
            Tell us about your project and we'll point you in the
            right direction.
          </p>
    ...
    <div className="grid lg:grid-cols-[35%_65%] gap-16">
      ...
      <div>
        ...
        <p className="text-[#5F5A55] mt-8 leading-relaxed">
          Select the option that best describes your project and
          we'll tailor our response accordingly.
        </p>
      ...
      {[
        {
          ...
          answer: "Timelines vary depending on the project scope, approvals and site conditions, but most projects move from design to completion within a few months."
        },
        {
          question: "Do you only work in Melbourne?",
          answer: "We primarily service Melbourne and surrounding areas, with select projects undertaken across Victoria."
        },
        {
          question: "Can a granny flat be used as a rental property?",
          answer: "Regulations vary by location. We can guide you through the options available for your property."
        },
        {
          question: "Do I need council approval?",
          answer: "Approval requirements depend on the size and type of structure. Our team can help identify the requirements for your site."
        }
      ].map((item) => (
    ...
    <div className="grid lg:grid-cols-[40%_60%] gap-16 items-center">
      ...
      <div>
        ...
        <p className="mt-8 text-[#5F5A55] leading-relaxed max-w-md">
          ...
          flexible living space, we'd love to discuss your ideas and
