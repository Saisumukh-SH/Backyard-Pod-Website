...
export default function GrannyProduct1() {
  const finishes = [
    ...
    },
    {
      id: "timber",
      name: "Natural Timber",
      subtitle: "Warm timber tones for an organic feel",
      color: "#C8A46B",
      image:
        "/images/grannyflat/grannyflatexmp/granny_flats_hero.webp",
    },
  ...
  return (
    <SingleGrannyFlatPage
      ...
      title="The Wattle"
      highlight="60"
      description="A spacious 60m² granny flat designed for modern Australian living. The Wattle 60 combines generous living areas, a practical layout and private bedroom accommodation to create a comfortable, independent space for family, guests or future rental accommodation."
      size="60 m²"
      beds="1"
      baths="1"
      warranty="10 Year"
